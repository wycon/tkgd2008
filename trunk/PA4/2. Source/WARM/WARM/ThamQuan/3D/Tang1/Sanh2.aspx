...
<ul id="nav">
	...
	<ul>
		<li><a href="../../Tang1/Sanh2.aspx" class="sub">2D</a></li>
	</ul>
		<div class="clear"></div>
	</li>
</ul>
		...
		<div class="panorama-view">
			<div class="panorama-container">
				...
				<map id="testmap" name="testmap"> 
					<area shape="arrow" coords="500,72,700,255" href="Sanh1.aspx" alt="Sảnh 1" /> 
					<area shape="arrow" coords="100,150,250,250" href="Sanh3.aspx" alt="Sảnh 3" /> 
				</map>
			</div>
		</div>
...
<asp:Label ID="Label1" runat="server" style="color:Black"  Text="Kiến trúc tầng 1"></asp:Label>
<br clear="all"/>
<div style="float:left;">
...
<ul>
	<li><a href="../../Tang1/Sanh2.aspx">2D</a></li>
