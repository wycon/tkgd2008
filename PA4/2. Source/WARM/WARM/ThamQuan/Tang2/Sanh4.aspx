<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sanh4.aspx.cs" Inherits="WARM.WebForm10" %>
...
<ul id="nav">
	...
	<ul>
		<li><a href="../3D/Tang2/Sanh4.aspx" class="sub">3D</a></li>
	</ul>
		<div class="clear"></div>
	</li>
</ul>
...
<div style="width:800px;">
 <div id="container" style="float: left;">
      ...
      <div id="banner">
        ...
        <ul class="bjqs">
          <li><img src="../../images/ThamQuan/Tang2/Sanh4/img/banner01.jpg"/></li>
          <li><img src="../../images/ThamQuan/Tang2/Sanh4/img/banner02.jpg"/></li>
          <li><img src="../../images/ThamQuan/Tang2/Sanh4/img/banner03.jpg"/></li>
        </ul>
...
<ul>
	...
	<li><a href="../3D/Tang2/Sanh4.aspx">3D</a></li>
</ul>
